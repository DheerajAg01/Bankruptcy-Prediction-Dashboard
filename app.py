...
.metric-card{background:linear-gradient(135deg,rgba(99,102,241,.12),rgba(15,23,42,.85));border-radius:12px;padding:12px;text-align:center;border:1px solid rgba(99,102,241,.18)}
